...
import { Alert, AlertTitle, AlertDescription } from '../ui/Alert'; // Fix path and capitalization
    ...
    <Card className="max-w-md mx-auto my-8">
      <CardContent className="p-6">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-600">Take a moment to assess your mental wellbeing</p>
          <Button 
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <Label className="text-base">1. Do you have any suicidal thoughts?</Label>
            <RadioGroup 
              className="flex justify-between"
              value={answers.suicidalThoughts}
              onValueChange={(value) => handleAnswerChange('suicidalThoughts', value)}
            >
              {[0,1,2,3,4].map((value) => (
            ...
            <Label className="text-base">2. Would you like to end your life?</Label>
            <RadioGroup 
              className="flex justify-between"
            ...
            <Label className="text-base">3. Do you have a plan for harming yourself?</Label>
            <RadioGroup 
              className="flex justify-between"
    ...
    <Card className="max-w-md mx-auto my-8">
      <CardContent className="p-6">
        <Alert>
          ...
          <AlertDescription>
            Thank you for completing the assessment. If you're experiencing thoughts of self-harm, please reach out to a mental health professional or call your local crisis helpline immediately.
          </AlertDescription>
        </Alert>
      </CardContent>
    </Card>
